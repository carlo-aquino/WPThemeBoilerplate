<?php if( have_rows( 'two-column_layout_settings' ) ): while( have_rows( 'two-column_layout_settings' ) ): the_row();
    ...
    <section id="<?php if( $css_id ) echo esc_attr($css_id); ?>" class="two-column-layout mobile-spacer
        <?php
    ...
    >
        ...
        <div class="container-fluid two-column-layout__wrapper <?php if( !$full_width ) echo 'content-limit'; ?>">
            ...
            <?php if( have_rows('column_01_settings') ): while( have_rows('column_01_settings') ): the_row();
                ...
                if( $column_link ) {
                    ...
                    <?php endif; ?>
                        ...
                        <div id="<?php if( $css_id ) echo esc_attr($css_id); ?>" class="two-column-layout__column-wrapper <?php if( $css_class ) echo esc_attr($css_class); ?> <?php if( !$column_gap ) echo 'p-0 '; ?>"
                            style="
                                <?php if( $background_type=='color' ) echo 'background-color:' . esc_attr($background_color) . ';'; ?>
                                <?php if( $background_type=='image' ) echo 'background-image:url(' . esc_url($background_image) . ');'; ?>
                                <?php if( $background_image_fixed && $background_image ) echo 'background-attachment: fixed;'; ?>
