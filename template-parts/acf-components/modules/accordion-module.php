...
<div id="<?php if( $css_id ) echo esc_attr($css_id); ?>" class="accordion-module<?php if( $css_class ) echo ' ' . esc_attr($css_class); ?>">
                ...
                <div class="accordion-module__accordions">
                    ...
                    <div class="accordion-module__content">
                        ...
                        ?>
                            ...
                            <label for="<?php echo 'accordion-content' . $randID . '-' . $accordionContentCTR; ?>"><?php echo esc_html($accordion_heading); ?></label>

                            <div
                                id="<?php echo 'accordion-content-' . $randID . '-' . $accordionContentCTR; if( $css_id ) echo ' ' . esc_attr($css_id); ?>"
                                class="accordion-module__content-container<?php if( $css_class ) echo ' ' . esc_attr($css_class); ?>"
